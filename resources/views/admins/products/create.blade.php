            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/admin/product/store" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="category_detail" class="col-md-4 col-form-label text-md-right">Product Category Detail</label>
                            <div class="col-md-6">
                                <select id="category_detail" name="category_detail" class="form-control{{ $errors->has('category_detail') ? ' is-invalid' : '' }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control summernote" rows="4" id="description" name="description"></textarea>
                        </div>
