...
<div class="container">
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <p>Laporan Penjualan Bulanan pada {{$year_report}}</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row justify-content-center">
    <div class="col-md-12">
      <h3>Grafik Pesanan {{$year_report}}</h3>
    ...
    <script>
      google.charts.load('current', {packages: ['corechart', 'line']});
                ...
                function drawBasic() {
                  ...
                  var data = google.visualization.arrayToDataTable([['Bulan', 'Pemasukan'],
                  @foreach ($subgroup as $key => $item)
                    ...
                    // data.addColumn('number', 'Total Nilai Tagihan');
              ...
              function monthName(monthNumber){
                var nameMonth = ["January", "February","Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember"];
    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <table id="tenantTable" class="table table-responsive table-striped table-hover" style="font-size: 10pt">
            <tr>
  ...
  <div class="row justify-content-center">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <span class="fa fa-clone"></span> Rincian Tagihan {{$year_report}}
