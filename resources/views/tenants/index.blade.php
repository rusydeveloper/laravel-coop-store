...
<form id="order-form" method="POST" action="/tenant/order/submit" enctype="multipart/form-data">
    {{ csrf_field() }}
    ...
    <div id="cart-full">
            <div id="cart-container">
                <div class="flex-container">
                  <div>
                   <input id="customer" type="text" class="form-custom form-control" name="customer" value="" placeholder="Pemesan" required>
               </div>
               <div>
                <input id="tableNumber" type="number" class="form-custom form-control" name="tableNumber" value="" placeholder="Nomor" required>
            </div>
        </div>
