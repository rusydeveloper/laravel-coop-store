                    ...
                    <div class="payment-form">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-daily" role="tabpanel"
                                ...
                                <hr>
                                <form method="POST" action="/cashier/report/daily" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                            ...
                            <div class="tab-pane fade" id="pills-weekly" role="tabpanel"
                                ...
                                <hr>
                                <form method="POST" action="/cashier/report/weekly" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                        <label for="report-category">Kategori Laporan</label>
                                        <div class="form-control form-custom">
                            ...
                            <div class="tab-pane fade" id="pills-monthly" role="tabpanel"
                                ...
                                <hr>
                                <form method="POST" action="/cashier/report/monthly" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                        <label for="report-category">Kategori Laporan</label>
                                        <div class="form-control form-custom">
                            ...
                            <div class="tab-pane fade" id="pills-periodic" role="tabpanel"
                                ...
                                <hr>
                                <form method="POST" action="/cashier/report/periodic" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                        <label for="report-category">Kategori Laporan</label>
                                        <div class="form-control form-custom">
