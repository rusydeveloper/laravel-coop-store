                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ App\Product::where('unique_id',$item->product_id)->first()->name }}</td>
                                <td>Rp {{number_format( App\Product::where('unique_id',$item->product_id)->first()->price,0,",",".")}}</td>
                                <td>{{$item->quantity}}</td>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body" style="text-align: center">
                                    <form method="POST" action="/manager/discount/verify/{{$invoice->unique_id}}" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                    ...
                                    <hr/> ATAU
                                    <hr/>
                                    <form method="POST" action="/manager/discount/{{$invoice->unique_id}}" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                    ...
                    <div class="payment-form">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="pills-oncash" role="tabpanel" aria-labelledby="pills-oncash-tab">
                                ...
                                <form method="POST" action="/manager/invoice/paid" enctype="multipart/form-data">
                                    {{ csrf_field() }}
