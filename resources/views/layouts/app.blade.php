...
<head>
  ...
  gtag('config', 'UA-148001077-1');
    ...
    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-138068435-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-138068435-1');
    </script>
...
<body>
    <div id="app">
        ...
        <main class="py-4 full-height main-background" style="">
            @yield('content')
        </main>
    </div>
</body>
