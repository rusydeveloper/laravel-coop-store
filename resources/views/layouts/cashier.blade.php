...
<body onload="startTime()">
    <div id="app">
        ...
        <div id="mySidenav" class="sidenav">
            <a href="{{route('cashier_order')}}"><span class="fa fa-shopping-basket"></span> Pesanan</a>
            <a href="{{route('cashier_payment')}}"><span class="fa fa-credit-card"></span> Payment</a>
            <a href="{{route('cashier_report')}}"><span class="fa fa-pie-chart"></span> Laporan</a>
        </div>
